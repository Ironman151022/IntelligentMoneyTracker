...
| Category | Spending or income classification | `id`, `name`, `parent_id?` | Food |
| Merchant | Payee, shop, brand, or platform | `id`, `name`, `aliases?` | Zomato |
| Beneficiary | Person for whom the transaction occurred | `id`, `name`, `relationship?` | Sister |
